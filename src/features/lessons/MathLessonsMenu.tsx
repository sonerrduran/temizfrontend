...
export default function MathLessonsMenu() {
  ...
  const lessonCards: LessonCard[] = [
    {
      ...
      route: '/lessons/math/learn',
    },
    {
      id: 'practice',
      title: 'PRATİK YAP',
      subtitle: 'Ders konularını öğren ve pratik yap!',
      icon: '✏️',
      gradient: 'from-blue-500 to-cyan-600',
      route: '/lessons/math/practice',
    },
    {
      id: 'games',
      title: 'OYUN ALANI',
      subtitle: 'Eğlenerek matematik öğren!',
      icon: '🎮',
      gradient: 'from-purple-500 to-pink-600',
      route: '/games?category=math',
    },
  ];
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/80 font-medium max-w-2xl mx-auto text-sm md:text-base mb-6">
            Sayılar, şekiller ve problemleri Matematik yolculuğuna hazır mısın?
          </p>
