...
interface TwoDigitAdditionGameProps {
  onBack: () => void;
}

const TwoDigitAdditionGame: React.FC<TwoDigitAdditionGameProps> = ({ onBack }) => {
  ...
  const generateQuestion = () => {
    ...
    const wrongOptions = [correctAnswer + 10, correctAnswer - 10, correctAnswer + 5];
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-600 via-emerald-500 to-teal-500 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          <h3 className="text-3xl font-black text-green-600 mb-8 text-center">
          ...
          <div className="bg-gradient-to-br from-yellow-100 to-orange-100 rounded-2xl p-12 mb-8 text-center border-4 border-yellow-400">
            <div className="flex items-center justify-center gap-8 text-8xl font-black text-green-600">
              <span>{num1}</span>
...
export default TwoDigitAdditionGame;
