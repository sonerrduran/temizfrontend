...
interface TwoDigitSubtractionGameProps {
  onBack: () => void;
}

const TwoDigitSubtractionGame: React.FC<TwoDigitSubtractionGameProps> = ({ onBack }) => {
  ...
  const generateQuestion = () => {
    ...
    const wrongOptions = [correctAnswer + 10, correctAnswer - 10, correctAnswer + 5].filter(
      (v) => v >= 0
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-600 via-rose-500 to-pink-500 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          <h3 className="text-3xl font-black text-red-600 mb-8 text-center">
            İki Basamaklı Çıkarma
          </h3>

          {/* Problem Display */}
          <div className="bg-gradient-to-br from-blue-100 to-cyan-100 rounded-2xl p-12 mb-8 text-center border-4 border-blue-400">
            <div className="flex items-center justify-center gap-8 text-8xl font-black text-red-600">
              <span>{num1}</span>
...
export default TwoDigitSubtractionGame;
