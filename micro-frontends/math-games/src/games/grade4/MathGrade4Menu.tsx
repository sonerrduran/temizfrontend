  ...
  const topics = [
    {
      ...
      name: 'Büyük Sayılar',
      icon: '🔢',
      description: 'Büyük sayılarla işlemler',
      games: [
        { path: '/games/math/grade4/bignumbers/place-value', name: 'Basamak Değeri' },
        { path: '/games/math/grade4/bignumbers/rounding', name: 'Yuvarlama' },
      ],
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-black text-white mb-2">4. Sınıf Matematik</h1>
