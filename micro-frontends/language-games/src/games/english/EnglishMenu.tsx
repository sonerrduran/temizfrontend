    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-900 via-orange-700 to-orange-500 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-white mb-2">English</h1>
          <p className="text-white/80 text-lg">Learn English with fun games!</p>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {grades.map((grade) => (
            ...
            >
              ...
              <div className="text-white/80 text-sm font-semibold">Grade</div>
            </button>
          ))}
        </div>
