...
const NumberComparisonGame: React.FC<NumberComparisonGameProps> = ({ onExit, onComplete }) => {
    ...
    const [questions, setQuestions] = useState<Array<{ num1: number; num2: number; correct: string }>>([]);
    ...
    const generateQuestions = () => {
        ...
        for (let i = 0; i < currentLevel.questions; i++) {
            ...
            newQuestions.push({ num1, num2, correct });
        }
...
export default NumberComparisonGame;
