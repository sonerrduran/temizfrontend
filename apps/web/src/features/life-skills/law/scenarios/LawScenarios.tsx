interface LawScenariosProps {
  gradeLevel: number;
  onExit: () => void;
}

export default function LawScenarios({ gradeLevel, onExit }: LawScenariosProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-black text-white mb-8">Hukuk Bilinci Senaryoları - {gradeLevel}. Sınıf</h1>
