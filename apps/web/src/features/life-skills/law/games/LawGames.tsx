interface LawGamesProps {
  gradeLevel: number;
  onExit: () => void;
}

export default function LawGames({ gradeLevel, onExit }: LawGamesProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-black text-white mb-8">Hukuk Bilinci Oyunları - {gradeLevel}. Sınıf</h1>
