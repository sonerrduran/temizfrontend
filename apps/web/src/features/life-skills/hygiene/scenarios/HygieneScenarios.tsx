  ...
  1: [
    {
      ...
      options: [
        { text: 'Hemen yemek yemeliyim', isCorrect: false, feedback: 'Tuvaletten sonra el yıkamak çok önemli!' },
        { text: 'Ellerimi yıkamalıyım', isCorrect: true, feedback: 'Doğru! Tuvaletten sonra mutlaka el yıka.' },
        { text: 'Sadece suyla çalkalamalıyım', isCorrect: false, feedback: 'Sabun kullanmak gerekli.' }
      ]
    }
  ],
  2: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Umursamamalıyım', isCorrect: false, feedback: 'Temizlik sosyal ilişkiler için önemli.' },
        { text: 'Hemen banyo yapmalıyım', isCorrect: true, feedback: 'Doğru! Düzenli banyo çok önemli.' },
  ...
  3: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Hemen almalıyım', isCorrect: false, feedback: 'Hasta kişilerden uzak durmalısın.' },
        { text: 'Kibarca reddetmeli, iyileşince oynamalıyım', isCorrect: true, feedback: 'Doğru! Hastalık bulaşabilir.' },
  ...
  4: [
    {
      ...
      options: [
        ...
        { text: 'Yememeli, taze yemek yapmalıyım', isCorrect: true, feedback: 'Doğru! Bozuk yemek yeme.' },
        { text: 'Kokusunu almadan yemeliyim', isCorrect: false, feedback: 'Bozuk yemek her zaman zararlıdır.' }
      ]
    }
  ],
  5: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Hemen gitmeliyim', isCorrect: false, feedback: 'Terli kıyafetle gitmek hijyenik değil.' },
        { text: 'Duş alıp temiz kıyafet giymeliyim', isCorrect: true, feedback: 'Doğru! Spordan sonra temizlik önemli.' },
  ...
  6: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Görmezden gelmeliyim', isCorrect: false, feedback: 'Diş ağrısı ciddiye alınmalı.' },
        { text: 'Diş hekimine gitmeliyim', isCorrect: true, feedback: 'Doğru! Erken tedavi önemli.' },
        { text: 'Sadece ağrı kesici almalıyım', isCorrect: false, feedback: 'Tedavi gerekli, ağrı kesici geçici çözüm.' }
      ]
    }
  ],
  7: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Sivilceleri sıkmalıyım', isCorrect: false, feedback: 'Sivilce sıkmak iz bırakır!' },
        { text: 'Yüzümü düzenli temizlemeli, gerekirse dermatoloğa gitmeliyim', isCorrect: true, feedback: 'Doğru! Düzenli temizlik ve profesyonel yardım önemli.' },
        { text: 'Makyajla kapatmalıyım', isCorrect: false, feedback: 'Makyaj sorunu çözmez, daha kötü yapabilir.' }
      ]
    }
  ],
  8: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Hasta olmadığım için gitmem', isCorrect: false, feedback: 'Düzenli kontrol önleyici sağlık için önemli.' },
        { text: 'Düzenli sağlık kontrolü yaptırmalıyım', isCorrect: true, feedback: 'Doğru! Erken teşhis hayat kurtarır.' },
        { text: 'Sadece hasta olunca giderim', isCorrect: false, feedback: 'Önleyici sağlık daha önemli.' }
      ]
    }
  ]
};
