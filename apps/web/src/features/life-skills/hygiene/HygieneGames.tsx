...
> = {
  1: [
    {
      id: 'hand-wash',
      title: 'El Yıkama Yarışması',
      icon: '🧼',
      description: 'Doğru el yıkama tekniği',
      color: 'from-blue-500 via-cyan-500 to-blue-600',
    },
    {
      id: 'tooth-brush',
      title: 'Diş Fırçalama Oyunu',
      icon: '🦷',
      description: 'Dişlerini doğru fırçala',
      color: 'from-cyan-500 via-teal-500 to-cyan-600',
    },
    {
      id: 'clean-dirty',
      title: 'Temiz-Kirli Eşleştirme',
      icon: '✨',
      description: 'Temiz ve kirli ayır',
    ...
    },
    {
      ...
      title: 'Mikrop Avcısı',
      icon: '🦠',
      description: 'Mikropları yakala',
      color: 'from-emerald-500 via-green-500 to-emerald-600',
    },
    {
      id: 'hygiene-hero',
      title: 'Hijyen Kahramanı',
      icon: '🦸',
      description: 'Temizlik görevleri',
  ...
  2: [
    {
      ...
      title: 'Banyo Zamanı',
      icon: '🛁',
      description: 'Banyo rutini öğren',
      color: 'from-blue-500 via-indigo-500 to-blue-600',
    },
    {
      id: 'clean-clothes',
      title: 'Temiz Kıyafet Seçimi',
      icon: '👕',
      description: 'Doğru kıyafeti seç',
    ...
    },
    {
      ...
      title: 'Saç Bakımı',
      icon: '💇',
      description: 'Saç temizliği ve bakımı',
      color: 'from-pink-500 via-rose-500 to-pink-600',
    },
    {
      id: 'hygiene-routine',
      title: 'Günlük Hijyen Rutini',
      icon: '📅',
      description: 'Günlük temizlik alışkanlıkları',
  ...
  3: [
    {
      id: 'germ-defense',
      title: 'Mikrop Savunması',
      icon: '🛡️',
      description: 'Mikroplardan korun',
      color: 'from-cyan-500 via-blue-500 to-cyan-600',
    },
    {
      id: 'sneeze-cover',
      title: 'Hapşırık Kapama',
      icon: '🤧',
      description: 'Doğru hapşırma tekniği',
    ...
    },
    {
      ...
      title: 'Uyku Hijyeni',
      icon: '😴',
      description: 'Sağlıklı uyku alışkanlıkları',
      color: 'from-sky-500 via-cyan-500 to-sky-600',
    },
    {
      id: 'sick-day',
      title: 'Hasta Günü Simülasyonu',
      icon: '🤒',
      description: 'Hasta olunca ne yapmalı',
      color: 'from-teal-500 via-emerald-500 to-teal-600',
    },
    {
      id: 'hygiene-quiz',
      title: 'Hijyen Bilgi Yarışması',
      icon: '❓',
      description: 'Hijyen bilgini test et',
      color: 'from-emerald-500 via-green-500 to-emerald-600',
    },
  ],
  4: [
    {
      id: 'flu-fighter',
      title: 'Grip Savaşçısı',
      icon: '💪',
      description: 'Gripten korunma yolları',
    ...
    },
    {
      ...
      title: 'Yemek Hijyeni',
      icon: '🍎',
      description: 'Gıda güvenliği kuralları',
    ...
    },
    {
      ...
      title: 'Su Güvenliği',
      icon: '💧',
      description: 'Temiz su kullanımı',
      color: 'from-pink-600 via-rose-600 to-pink-700',
    },
    {
      id: 'hygiene-detective',
      title: 'Hijyen Dedektifi',
      icon: '🔍',
      description: 'Hijyen hatalarını bul',
      color: 'from-rose-600 via-red-600 to-rose-700',
    },
  ],
  5: [
    {
    ...
    },
    {
      ...
      title: 'Saç Sağlığı',
      icon: '💆',
      description: 'Saç bakımı ve hijyen',
    ...
    },
    {
      ...
      title: 'Spor Hijyeni',
      icon: '⚽',
      description: 'Spor sonrası temizlik',
      color: 'from-sky-600 via-cyan-600 to-sky-700',
    },
    {
      id: 'sun-protection',
      title: 'Güneş Koruması',
      icon: '☀️',
      description: 'Güneşten korunma',
      color: 'from-teal-600 via-emerald-600 to-teal-700',
    },
    {
      id: 'wound-care',
      title: 'Yara Bakımı',
      icon: '🩹',
      description: 'Yaraları temizleme',
  ...
  6: [
    {
      id: 'puberty-hygiene',
      title: 'Ergenlik Hijyeni',
      icon: '🧑',
      description: 'Ergenlikte hijyen',
      color: 'from-blue-700 via-indigo-700 to-blue-800',
    },
    {
      id: 'deodorant-use',
      title: 'Deodorant Kullanımı',
      icon: '🧴',
      description: 'Ter kokusu kontrolü',
    ...
    },
    {
      ...
      title: 'Diş Sağlığı',
      icon: '🦷',
      description: 'Ağız ve diş bakımı',
      color: 'from-purple-700 via-pink-700 to-purple-800',
    },
    {
      id: 'floss-master',
      title: 'Diş İpi Ustası',
      icon: '🧵',
      description: 'Diş ipi kullanımı',
      color: 'from-pink-700 via-rose-700 to-pink-800',
    },
    {
      id: 'hygiene-planner',
      title: 'Hijyen Planlayıcı',
      icon: '📋',
      description: 'Kişisel hijyen planı',
      color: 'from-rose-700 via-red-700 to-rose-800',
    },
  ],
  7: [
    {
      ...
      title: 'Akne Bakımı',
      icon: '🧴',
      description: 'Akne ile başa çıkma',
    ...
    },
    {
      ...
      title: 'Cilt Rutini',
      icon: '💆',
      description: 'Günlük cilt bakımı',
      color: 'from-blue-700 via-sky-700 to-blue-800',
    },
    {
      id: 'stress-hygiene',
      title: 'Stres ve Hijyen',
      icon: '🧘',
      description: 'Stres yönetimi',
      color: 'from-sky-700 via-cyan-700 to-sky-800',
    },
    {
      id: 'sleep-quality',
      title: 'Uyku Kalitesi',
      icon: '😴',
      description: 'İyi uyku hijyeni',
      color: 'from-teal-700 via-emerald-700 to-teal-800',
    },
    {
      id: 'hygiene-expert',
      title: 'Hijyen Uzmanı',
      icon: '🎓',
      description: 'İleri seviye hijyen',
      color: 'from-emerald-700 via-green-700 to-emerald-800',
    },
  ],
  8: [
    {
      ...
      title: 'Üreme Sağlığı',
      icon: '🩺',
      description: 'Üreme sağlığı hijyeni',
    ...
    },
    {
      ...
      color: 'from-indigo-800 via-purple-800 to-indigo-900',
    },
    {
    ...
    },
    {
      ...
      title: 'Hijyen Bilinci',
      icon: '🧠',
      description: 'Hijyen farkındalığı',
      color: 'from-pink-800 via-rose-800 to-pink-900',
    },
    {
      id: 'life-hygiene',
      title: 'Yaşam Hijyeni',
      icon: '🌟',
      description: 'Kapsamlı hijyen yaklaşımı',
      color: 'from-rose-800 via-red-800 to-rose-900',
    },
  ],
};
