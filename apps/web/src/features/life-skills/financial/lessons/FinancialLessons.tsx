...
export default function FinancialLessons({ gradeLevel, onExit }: FinancialLessonsProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-amber-900 to-slate-900 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-black text-white mb-8">Finansal Okuryazarlık Dersleri - {gradeLevel}. Sınıf</h1>
