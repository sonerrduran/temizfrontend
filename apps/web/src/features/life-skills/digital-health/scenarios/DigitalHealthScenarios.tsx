interface DigitalHealthScenariosProps {
  gradeLevel: number;
  onExit: () => void;
}

export default function DigitalHealthScenarios({ gradeLevel, onExit }: DigitalHealthScenariosProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-violet-900 to-slate-900 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-black text-white mb-8">Dijital Sağlık Senaryoları - {gradeLevel}. Sınıf</h1>
