...
const topicsByGrade: Record<string, Array<{ id: string; name: string; icon: string; description: string }>> = {
  '1': [
    { id: 'letters', name: 'Harfler', icon: '🔤', description: 'Harf tanıma ve yazma' },
    { id: 'reading', name: 'Okuma', icon: '📖', description: 'Hece ve kelime okuma' },
    { id: 'writing', name: 'Yazma', icon: '✍️', description: 'Harf ve kelime yazma' },
  ],
  '2': [
    { id: 'reading', name: 'Okuma', icon: '📖', description: 'Akıcı okuma' },
    { id: 'writing', name: 'Yazma', icon: '✍️', description: 'Cümle yazma' },
    { id: 'grammar', name: 'Dil Bilgisi', icon: '📝', description: 'Temel dilbilgisi' },
    { id: 'vocabulary', name: 'Kelime', icon: '📚', description: 'Kelime hazinesi' },
  ],
  '3': [
    { id: 'reading', name: 'Okuma', icon: '📖', description: 'Anlayarak okuma' },
    { id: 'writing', name: 'Yazma', icon: '✍️', description: 'Paragraf yazma' },
    { id: 'grammar', name: 'Dil Bilgisi', icon: '📝', description: 'Cümle yapısı' },
    { id: 'vocabulary', name: 'Kelime', icon: '📚', description: 'Eş ve zıt anlamlı' },
  ],
  '4': [
    ...
    { id: 'vocabulary', name: 'Kelime', icon: '📚', description: 'Deyimler ve atasözleri' },
  ],
  '5': [
...
export default function TurkishLearnGrade() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-900 via-red-700 to-orange-600 p-8">
      <div className="w-full max-w-7xl mx-auto px-2">
        <div className="mb-8">
          <button
            onClick={() => navigate('/lessons/turkish/learn')}
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-white mb-2">{gradeNumber}. Sınıf Türkçe</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto pb-32">
          {topics.map((topic) => (
            <GameCard
              ...
              onClick={() => alert(`${topic.name} konusu yakında eklenecek!`)}
            />
          ))}
        </div>
      </div>
