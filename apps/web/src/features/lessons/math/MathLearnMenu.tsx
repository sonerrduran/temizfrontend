...
export default function MathLearnMenu() {
      ...
      <div className="w-full max-w-7xl mx-auto px-2">
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-white mb-2">Matematik - Öğren</h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 max-w-7xl mx-auto pb-32">
          {grades.map((grade) => (
            <GameCard
              ...
              onClick={() => navigate(`/lessons/math/learn/grade${grade}`)}
            />
          ))}
        </div>
